...
import { Plus, Trash2, Megaphone, TrendingUp, FileText } from 'lucide-react'
...
const CATEGORIES = [
  { value: 'sales', label: 'Sales', icon: TrendingUp, color: 'text-emerald-400', bg: 'bg-emerald-950/40 border-emerald-800/40' },
  { value: 'contenu', label: 'Contenu', icon: Megaphone, color: 'text-blue-400', bg: 'bg-blue-950/40 border-blue-800/40' },
...
export default function Sales() {
  ...
  const [form, setForm] = useState({ title: '', content: '', category: 'sales' })
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-xl font-bold text-white">Sales & Contenu</h1>
          <p className="text-sm text-zinc-500 mt-0.5">Notes & idées — Lilian & Selim</p>
        </div>
        ...
        <div className="bg-brand-surface border border-brand-border rounded-xl p-4 mb-4">
          <form onSubmit={handleAdd} className="space-y-3">
            ...
            <textarea
              ...
              placeholder="Contenu, idée, action à faire..."
              rows={4}
